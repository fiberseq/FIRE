...
kk=p+plot_spacer()+percent_plots+plot_layout(heights = c(1,-0.3, 3))
...
system("tabix -R temp/low_acc_peaks.bed results/GM12878_130X/FIRE.bed.gz > temp/low_acc_fires.bed")
