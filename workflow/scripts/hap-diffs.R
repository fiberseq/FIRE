...
tdf %>%
    ...
    scale_x_continuous("H1 accessibility", labels = percent) +
    scale_y_continuous("H2 accessibility", labels = percent) +
...
p <- tdf %>%
    ...
    facet_wrap(~autosome, ncol = 2) +
    scale_x_continuous("Difference between H1 and H2 accessibility", labels = percent) +
    scale_y_continuous(
        glue("p-value   (n = {n})"),
        # labels=comma,
